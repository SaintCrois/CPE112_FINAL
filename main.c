...
void CashOut() 
{
    ...
    int found = 0;
    clearter();
    printf("Enter 0 to go back MENU\n");
...
int main() {
    ...
    while (1) {
        system("cls");
        printf("%s*** %sWELCOME TO %sNA%sMO%s999 %s***%s\n",
       GOLD,                   // Gold ***
       WHITE,                  // "WELCOME TO" in white
       RED,                    // "NA" in red
       BLACK,                  // "MO" in green
       LIGHT_GREEN,                   // "999" in gold
       GOLD,                   // Gold ***
       RESET);
        printf("---------------------------\n");
        printf("ENTER 1: Register\n");
        printf("%sENTER 2: %sCash %sin%s\n", LIGHT_GREEN,LIGHT_GREEN, GREEN, RESET);
        printf("%sENTER 3: %sCash %sout%s\n", LIGHT_GREEN, LIGHT_GREEN, RED, RESET);
        printf("%sENTER 4: List of the WEALTHIEST %s$%s\n", SLIVER, GOLD, RESET);
        printf("%sENTER 5: START GAME%s\n", YELLOW, RESET);
